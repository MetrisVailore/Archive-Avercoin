...
from AverCoin.test import private1, private2, private3, public1, public2, public3
...
class TestChain(unittest.TestCase):
    def test_createLongChainValid(self):
        ...
        # 1 has 1000 SPC
        b1 = mine.generateNextBlock(testChain.head, [tx1, tx2], MIN_MINING_DIFFICULTY)
        ...
        b2 = mine.generateNextBlock(testChain.head, [tx3], MIN_MINING_DIFFICULTY)
        ...
        b3 = mine.generateNextBlock(testChain.head, [badTx, tx4], MIN_MINING_DIFFICULTY)
        ...
        b3 = mine.generateNextBlock(testChain.head, [tx5, tx4], MIN_MINING_DIFFICULTY)
        testChain.addBlock(b3)
        ...
        b3alt = mine.generateNextBlock(b2, [tx4alt], MIN_MINING_DIFFICULTY)
        ...
        b4alt = mine.generateNextBlock(b3alt, [tx5alt], MIN_MINING_DIFFICULTY)
        with self.assertRaises(chain.UTXOException):
